...
export function MyButton() {
  ...
  async function showRegistrationArray() {
    const registration = await getRegistration("MyUsername");
  ...
  async function login() {
    ...
    let registration: RegistrationParsed;
    registration = await getRegistration("bob");
    if (!registration) {
      alert("Registration not found");
      return "Registration not found";
    }
    let existChallenge = registration.client.challenge;
